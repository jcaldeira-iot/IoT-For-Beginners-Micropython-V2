...
> ⚠️ UART was covered in [project 2, lesson 6](../../../2-farm/lessons/6-detect-soil-moisture/README.md#universal-asynchronous-receiver-transmitter-uart). Refer back to that lesson if needed.
...
* **[Microcontroller ESP32](esp32-gps-sensor.md) <<<<----------**
...
Rather than use the raw NMEA data, it is better to decode it into a more useful format.

### Task - decode GPS sensor data

Work through the relevant guide to decode GPS sensor data using your IoT device:

* **[Microcontroller ESP32](esp32-gps-decode.md) <<<<----------**

---

## 🚀 Challenge

Write your own NMEA decoder! Can you create a decoder to extract complete data from NMEA sentences?
