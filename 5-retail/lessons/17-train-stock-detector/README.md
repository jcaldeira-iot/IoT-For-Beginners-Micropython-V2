...
1. Create a free Custom Vision training resource, and a free Custom Vision prediction resource in the `stock-detector` resource group. Name them `stock-detector-training` and `stock-detector-prediction`.
    ...
    > ⚠️ You can refer to [the instructions for creating training and prediction resources from project 4, lesson 13 if needed](../../../4-manufacturing/lessons/13-train-fruit-detector/README.md#task---create-a-cognitive-services-resource).
