# Call your object detector from your IoT device - Virtual IoT device
...
1. Replicate the steps from [lesson 2 of the manufacturing project](../../../4-manufacturing/lessons/14-check-fruit-from-device/virtual-device-camera.md) to capture images from the camera.

1. Replicate the steps from [lesson 2 of the manufacturing project](../../../4-manufacturing/lessons/14-check-fruit-from-device/virtual-device-classify-image.md) to call the image classifier. The majority of this code will be re-used to detect objects.
