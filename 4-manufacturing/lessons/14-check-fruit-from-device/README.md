...
* **[Virtual IoT device](virtual-device-camera.md) <<<<----------**
...
* **[Virtual IoT device](virtual-device-classify-image.md) <<<<----------**
...
1. In the Custom Vision portal, retrain the model using the images on the *Predictions* tab.
    ...
    > ⚠️ You can refer to [the instructions for retraining your classifier in lesson 13 if needed](../13-train-fruit-detector/README.md#retrain-your-image-classifier).
