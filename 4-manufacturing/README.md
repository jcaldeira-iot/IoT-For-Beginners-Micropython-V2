...
13. [Train a fruit quality detector](./lessons/13-train-fruit-detector/README.md)
1. [Check fruit quality from an IoT device](./lessons/14-check-fruit-from-device/README.md)
1. [Run your fruit detector on the edge](./lessons/15-run-fruit-detector-edge/README.md)
1. [Trigger fruit quality detection from a sensor](./lessons/16-trigger-fruit-detector/README.md)
