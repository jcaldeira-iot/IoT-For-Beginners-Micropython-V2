...
### Task - Connect your IoT device to MQTT broker
...
* **[Microcontroller ESP32](esp32-mqtt.md) <<<<----------**
...
### Task - Send telemetry to MQTT broker from your IoT device
...
* **[Microcontroller ESP32](esp32-telemetry.md) <<<<----------**

### Receive telemetry from the MQTT broker (server side)
...
### Task - send commands to the MQTT broker (server side)
...
* **[Microcontroller ESP32](esp32-commands.md) <<<<----------**
