...
Microcontrollers are typically low cost computing devices, with average prices for the ones used in custom hardware dropping to around US$0.50, and some devices as cheap as US$0.03. Developer kits can start as low as US$4, with costs rising as you add more features. The [Wio Terminal](https://www.seeedstudio.com/Wio-Terminal-p-4509.html), a microcontroller developer kit from [Seeed studios](https://www.seeedstudio.com) that has sensors, actuators, WiFi and a screen costs around US$30. The [esp32-s3-n8r8](https://www.waveshare.com/wiki/ESP32-S3-DEV-KIT-N8R8) is another microcontroller development kit ideal for prototyping, featuring built-in Wi-Fi connectivity, and costs around US$10.

![A Wio Terminal](../../../images/wio-terminal.png)  ![A ESP32](../../../images/esp32-s3-dev-kit-n8r8.png)
...
> 💁 Microcontrollers are usually programmed in C/C++, MicroPython or CircuitPython.
...
All the subsequent lessons include assignments using an IoT device to interact with the physical world and communicate with the cloud. Each lesson in this guide was designed to use the [esp32-s3-n8r8](https://www.waveshare.com/wiki/ESP32-S3-DEV-KIT-N8R8). For other options such as an Arduino (using a Seeed Studio Wio Terminal) or a single-board computer, either a physical device like a Raspberry Pi 4 or a virtual one running on your PC or Mac please refer to the original guide at https://github.com/microsoft/IoT-For-Beginners.
...
Before you can get started with programming your IoT device, you will need to do a small amount of setup. Follow the relevant instructions below.
